...
<body style="background-color: #f7f5fa; margin: 0 !important; padding: 0 !important;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td bgcolor="#435EBE" align="center">
        ...
        <tr>
            <td bgcolor="#435EBE" align="center" style="padding: 0px 10px 0px 10px;">
                <table border="0" cellpadding="0" cellspacing="0" width="480">
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top"
                            ...
                            <h1 style="font-size: 32px; font-weight: 400; margin: 0;">Laporan Timbangan Kurang</h1>
                        </td>
                    </tr>
                </table>
            </td>
                                    ...
                                    <td bgcolor="#ffffff" align="center"
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                $tgl = date('Y-m-d');
                                                @endphp
                                                <td align="left" style="border-radius: 3px;" bgcolor="#435EBE">
                                                    <a href="http://127.0.0.1:8000/print_timbangan?sub_no_po=PO1001-001"
                                                        target="_blank"
                                                        style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 11px 22px; border-radius: 2px; border: 1px solid #435EBE; display: inline-block;">View</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
