...
<div id="main">
    ...
    <div class="page-heading">
        ...
        <form action="{{route('edit_save_pembelian_po')}}" method="post">
            @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="qty[]" style="text-align: right;"
                                                class="form-control qty_beli qty_beli{{$p->id_purchase}}"
                                                value="{{$p->qty_beli}}" detail='{{$p->id_purchase}}'>
                                        </td>
                                        <td>{{$p->nm_satuan}}</td>
                                        <td><input type="text" name="h_satuan[]" style="text-align: right;"
                                                class="form-control h_satuan h_satuan{{$p->id_purchase}}"
                                                value="{{$p->hrga_satuan_beli}}" detail='{{$p->id_purchase}}'></td>
                                        <td><input type="text" name="ttl_rp[]" style="text-align: right;"
                                                class="form-control total{{$p->id_purchase}}"
                                                value="{{$p->ttl_rp_pembelian}}" readonly>
                                        </td>
                                    </tr>
                                    @endforeach
