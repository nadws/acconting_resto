                            ...
                            <table class="table" id="table1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $d->nm_kategori }}</td>
                                        <td align="center">
                                            <a href="#" class="btn btn-sm btn-warning editKategoriMakanan"
                                                nm_kategori="{{$d->nm_kategori}}"
                                                id_kategori_makanan="{{ $d->id_kategori_makanan }}"><i
                                                    class="fas fa-pen"></i></a>

                                            @php
                                            $adaStok = DB::table('tb_list_bahan')->where('id_kategori_makanan',
                                            $d->id_kategori_makanan)->first();
                                            @endphp
                                            @if (empty($adaStok))
                                            <a onclick="return confirm('Yakin ingin dihapus ?')"
                                                href="{{ route('hapus_kategori_makanan', [$d->id_kategori_makanan, $id_jenis]) }}"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <label for="list_kategori">Kategori Makanan</label>
                                <input required autofocus type="text" name="nm_kategori"
                                    class="form-control nm_kategori">
                            </div>
                        </div>
                    </div>
                </div>
