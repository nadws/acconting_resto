                ...
                <form action="{{ route('save_opname') }}" method="post">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <label for="">Filter Kategori Makanan</label>
                                </div>
                                <div class="col-lg-4">
                                    <select name="" id="" class="select2 filterKategoriMakanan">
                                        <option value="">ALL</option>
                                        @foreach ($kategori as $d)
                                            <option {{$d->id_kategori_makanan == $id_kategori ? 'selected' : ''}} value="{{ $d->id_kategori_makanan }}">{{ $d->nm_kategori }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                    ...
                                    @foreach ($gudang as $no => $j)
                                        <tr>
                                            ...
                                            <td width="15%">
                                                ...
                                                <input type="hidden" name="stok_po[]" class="form-control"
                                                    value="{{ $stk }}">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-switch form-switch2">
                                            <input class="form-check-input form-check-input2 " name="monitoring"
                                                value="Y" type="checkbox" id="flexSwitchCheckDefault" />
                                        </div>
                                    </div>
                                </div>
                            </div>
