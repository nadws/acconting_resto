<table class="table" id="table2">
    ...
    <tbody>
        ...
        <input type="text" style="display: none;" name="jenis_edit[]" value="{{ $d->jenis }}">
            <tr>
                <td><input value="{{ $d->urutan }}" id="urutan" type="number" class="form-control" name="urutan_edit[]"></td>
                <td><input value="{{ $d->sub_kategori }}" id="sub_kategori" type="text" class="form-control" name="sub_kategori_edit[]"></td>
                <td>
                    <center>
                        
                        <a href="#"
                            class="btn btn-sm btn-danger btnDeleteSubKategori" id_jenis="{{ $d->jenis }}" id="{{$d->id}}"><i class="fas fa-trash-alt"></i></a>
                    </center>
