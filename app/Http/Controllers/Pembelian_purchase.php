...
class Pembelian_purchase extends Controller
{
    public function index(Request $r)
    {
        $data = [
            ...
            'purchase' => DB::select("SELECT a.tgl, a.no_po, a.admin, sum(a.ttl_rp) as total, a.beli, sum(b.ttl_rp) as total_beli, b.admin as admin_beli
            FROM purchase as a 
    ...
    {
        $no_po = $r->no_po;
        $detail = DB::select("SELECT a.tgl, a.no_po, b.nm_bahan, c.nm_satuan, a.qty, a.rp_satuan, a.ttl_rp, 
